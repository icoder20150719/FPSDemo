...
@end
@interface ICMemoryWaveController ()<WeakTargetDelegate>
@property (nonatomic,strong)ICWaveView *waveView;
@end
@implementation ICMemoryWaveController
{
    CADisplayLink *_link;
    NSUInteger _count;
...
- (void)viewDidLoad {
    [super viewDidLoad];
    ICWaveView *waveView = [[ICWaveView alloc]initWithFrame:CGRectMake(0,0, 100, 100)];
...
- (void)tick:(CADisplayLink *)link {
    ...
    if (_duration % 4 == 0) {
        ...
        self.waveView.fpsLabel.text = [NSString stringWithFormat:@"%d帧",(int)round(fps)];
    }
